        ...
        <Navbar shouldHideOnScroll maxWidth="2xl" className={`h-[100px] ${geist.className}`} >
            <NavbarBrand>
                <Link href="/" className="flex items-center" >
                    <Image className="transition-all duration-300ms ease-in-out -ml-5" src={`https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/${pokemonId}.png`} alt="icono de pokemon" width={80} height={100}  />
